                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="overflow-hidden overflow-x-auto min-w-full align-middle sm:rounded-md">
                        <table class="min-w-full divide-y divide-gray-200 border">
                                ...
                                <tr>
                                    <th rowspan ="2" colspan ="3"class="px-7 py-5 bg-red-50" style ="background-color:#645C8B; font-color:white;">
                                        <span class="text-center text-xs leading-4 font-medium uppercase tracking-wider">
                                                <p style ="font-size:25px; color:#FAF5F5;"> NON-UNIFORMED </p>
                                        </span>
                                    </th>
                                </tr>
                            </thead>
                            ...
                            @foreach($nonuniformed as $nonuniformed)
                                <tr class="bg-white" style="text-align:center; background-color: #FAFAFF;">
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
                                        {{ $nonuniformed->lower_medicinename }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
                                        {{ $nonuniformed->total_quantity }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
                                        {{ DateTime::createFromFormat('!m', $nonuniformed->prescription_month )->format('F')}} {{ \Carbon\Carbon::now()->year }}
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
